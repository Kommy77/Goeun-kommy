...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white flex flex-col items-center justify-center px-6">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-2">FreshKeeper</h1>
      ...
      <Button
        ...
        size="lg"
        className="w-full max-w-sm bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 py-6 text-base gap-3"
      >
